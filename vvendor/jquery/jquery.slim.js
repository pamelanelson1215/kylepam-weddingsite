...
// Microsoft forgot to hump their vvendor prefix (#9572)
...
// Return a vvendor-prefixed property or undefined
function vvendorPropName( name ) {

	// Check for vvendor prefixed names
...
// Return a potentially-mapped jQuery.cssProps or vvendor prefixed property
function finalPropName( name ) {
	var final = jQuery.cssProps[ name ] || vvendorProps[ name ];
	...
	return vvendorProps[ name ] = vvendorPropName( name ) || name;
}
